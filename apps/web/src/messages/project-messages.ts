...
export const englishProjectMessages = {
  ...
  detail: {
    ...
    tasksTitle: "Tasks",
    tasksDescription: "Concrete work items for this project.",
    milestonesTitle: "Milestones",
    milestonesDescription: "Lightweight phase boundaries.",
...
export const simplifiedChineseProjectMessages: ProjectMessages = {
  ...
  detail: {
    ...
    tasksTitle: "任务",
    tasksDescription: "这个项目中的具体工作项。",
    milestonesTitle: "里程碑",
    milestonesDescription: "轻量的阶段边界。",
    overviewTitle: "概览",
    new: "新建",
    edit: "编辑",
    description: "目标",
  ...
  results: {
    ...
    project_database_tables_missing:
      "项目数据库表缺失。使用项目功能前请运行 pnpm --dir apps/web db:migrate。",
