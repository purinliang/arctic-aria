...
const englishMessages = {
  ...
  settings: {
    ...
    developerImport: {
      ...
      description: "Parse or import project and routine templates.",
      emptyInputMessage: "Paste Markdown or JSON before running import tools.",
      ...
      title: "Developer Import",
    },
    developerTools: {
      avg: "Avg",
      copyMarkdown: "Copy Markdown",
      description: "Only visible to developers.",
      ...
      metric: "Metric",
      metrics: {
        clientTotalMs: "Frontend -> Server -> Database",
        databaseMs: "Server -> Database",
        networkEstimateMs: "Frontend/server overhead",
        serverTotalMs: "Server handler",
      },
      min: "Min",
      notifications: {
...
const simplifiedChineseMessages: AppMessages = {
  ...
  settings: {
    ...
    developerImport: {
      copyTemplate: "复制模板",
      description: "解析或导入项目与日常模板。",
      emptyInputMessage: "请先粘贴 Markdown 或 JSON。",
    ...
    developerTools: {
      ...
      metric: "指标",
      metrics: {
        clientTotalMs: "前端 -> 服务器 -> 数据库",
        databaseMs: "服务器 -> 数据库",
        networkEstimateMs: "前端/服务器开销估算",
        serverTotalMs: "服务器处理",
      },
      min: "最小",
      notifications: {
