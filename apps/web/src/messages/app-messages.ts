...
const simplifiedChineseMessages: AppMessages = {
  ...
  settings: {
    ...
    discord: {
      ...
      bindInstructionExpired:
        "{code} 已过期。请重新创建代码来连接 Discord。",
      bindingCodeTitle: "绑定代码",
      cancel: "取消",
      cancelConnectionDescription: "取消这次连接，之后可以重新创建代码。",
      cancelConnectionTitle: "取消连接",
      checkAgain: "重新检查",
      ...
      connectionStatusDescription: "当前 Discord 连接状态。",
