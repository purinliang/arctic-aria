...
test("builds Today Review text from dashboard items", () => {
  ...
  assert.equal(
    ...
    [
      ...
      "",
      "You finished 1 task and 1 routine today. You also experienced 1 pinned memory.",
      "",
      "### Tasks",
...
test("uses friendly zero-count Today Review text", () => {
  ...
  assert.equal(
    ...
    [
      ...
      "",
      "No tasks or routines were finished today. No pinned memories were experienced today.",
      "",
      "### Tasks",
