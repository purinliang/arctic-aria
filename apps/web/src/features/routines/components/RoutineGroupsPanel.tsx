// Routines Page - Routine Groups Panel.
...
import type { RoutineGroupFilter } from "./routine-page-helpers";

export function RoutineGroupsPanel({
  darkMode,
  filter,
  groups,
  pending,
  ...
  onFilterChange: (filter: RoutineGroupFilter) => void;
  onManage: () => void;
}) {
  return (
    <Panel darkMode={darkMode}>
      ...
      <div className="px-4 py-3">
        <SingleChoiceGroup
          ...
          onChange={(value) => onFilterChange(value as RoutineGroupFilter)}
        />
      </div>
    </Panel>
  );
