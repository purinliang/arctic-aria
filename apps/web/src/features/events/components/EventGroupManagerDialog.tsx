// Events Page - Event Group Manager Dialog.
...
import type { EventGroupInput } from "@/features/events/actions";
import type { EventMessages } from "@/messages/app-messages";

export function EventGroupManagerDialog({
  darkMode,
  pending,
  saving,
  groups,
  ...
  groupDraft: EventGroupInput;
  groupFormOpen: boolean;
  messages: EventMessages["groups"];
  setGroupDraft: Dispatch<SetStateAction<EventGroupInput>>;
  onCloseEditor: () => void;
  onCloseForm: () => void;
  onOpenNew: () => void;
  onOpenEdit: (group: EventGroupOption) => void;
  onSubmit: () => void;
  onDelete: (group: EventGroupOption) => void;
}) {
  return (
    <>
      <DialogOverlay>
